...
saveRDS(escapement_plus_concentrations_plot, file = "plots/escapement_plus_concentrations_plot.rds")
...
ggsave(escapement_plus_concentrations_plot, file = "plots/escapement_plus_concentrations_plot.pdf",
...
ggsave(six_panel_cow, file = "plots/new_fig1.pdf", dpi = 600, width = 9, height = 9)
ggsave(six_panel_cow, file = "plots/new_fig1.jpg", dpi = 600, width = 9, height = 9)
saveRDS(six_panel_cow, file = "plots/new_fig1.rds")
...
ggsave(new_fig2, file = "plots/new_fig2.jpg", dpi = 600, width = 8, height = 8)
saveRDS(new_fig2, file = "plots/new_fig2.rds")
...
nut_location = species_location_series %>% 
  ...
  geom_linerange(aes(ymin = low75, ymax = high75), alpha = 1,
                 size = .5) +
  geom_point(size = 0.2, shape = 22, aes(fill = panel)) +
...
ggsave(new_fig3, file = "plots/new_fig3.jpg", dpi = 600, width = 8, height = 4.5)
ggsave(new_fig3, file = "plots/new_fig3.pdf", dpi = 600, width = 8, height = 4.5)
saveRDS(new_fig3, file = "plots/new_fig3.rds")
...
ggsave(fig_4new, file = "plots/fig_4new.jpg", dpi = 600, width = 10, height = 5)
ggsave(fig_4new, file = "plots/fig_4new.pdf", dpi = 600, width = 10, height = 5)
